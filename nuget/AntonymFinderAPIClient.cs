...
namespace APIVerve.API.AntonymFinder
{
    ...
    /// <summary>
    /// Client for the AntonymFinder API
    /// </summary>
    public class AntonymFinderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/antonym";
        ...
        {
            { "word", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public AntonymFinderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AntonymFinderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AntonymFinderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AntonymFinderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(AntonymFinderQueryOptions options)
        {
        ...
        public ResponseObj Execute(AntonymFinderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AntonymFinderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AntonymFinderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AntonymFinderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AntonymFinderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AntonymFinderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(AntonymFinderQueryOptions options)
        {
