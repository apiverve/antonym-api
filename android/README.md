...
```gradle
dependencies {
    implementation 'com.github.apiverve:antonym-api:1.1.12'
}
```
...
```java
import com.apiverve.antonym.AntonymFinderAPIClient;
import com.apiverve.antonym.APIResponse;
import com.apiverve.antonym.APIException;

// Initialize the client
AntonymFinderAPIClient client = new AntonymFinderAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/antonym](https://docs.apiverve.com/ref/antonym)
...
- **Documentation:** [https://docs.apiverve.com/ref/antonym](https://docs.apiverve.com/ref/antonym)
- **Issues:** [GitHub Issues](https://github.com/apiverve/antonym-api/issues)
