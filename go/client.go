// Package antonym provides a Go client for the Antonym Finder API.
//
// For more information, visit: https://antonym.apiverve.com?utm_source=go&utm_medium=readme
package antonym
...
const (
	baseURL        = "https://api.apiverve.com/v1/antonym"
	defaultTimeout = 30 * time.Second
)

// Client is the Antonym Finder API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Antonym Finder API client.
...
// Execute makes a request to the Antonym Finder API with typed parameters.
//
...
//   - word (required): string - The word to get the antonyms for
