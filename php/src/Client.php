...
/**
 * Client for the Antonym Finder API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://antonym.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/antonym';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AntonymClient] {$message}\n";
        }
    }
}
